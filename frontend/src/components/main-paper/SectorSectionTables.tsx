/** PATH: main-paper/SectorSectionTables.tsx — Cards 6.4 (Trends) + 6.5 (Leaders) */
import { Link } from "react-router-dom"
import { XAxis, YAxis, CartesianGrid, Tooltip as RechartsTooltip, Legend, LineChart, Line } from "recharts"
import { SafeChart } from "@/components/SafeChart"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table"

export function SectorSectionTables({ rdTrendData, rdLeadersBySector }: { rdTrendData: any[]; rdLeadersBySector: any[] }) {
  return (
    <>
