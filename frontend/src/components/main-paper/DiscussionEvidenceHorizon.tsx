/** PURPOSE: Discussion – Evidence summary (8.1) and Horizon dependence (8.2) */

import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table"

export function DiscussionEvidenceHorizon({ snapshotPayload, annualHmlData, headlinePremiums, transactionCosts, rolling20yrEndpoints, regimePremiumTable }: { snapshotPayload: any; annualHmlData: any; headlinePremiums: any[]; transactionCosts: any; rolling20yrEndpoints: any; regimePremiumTable: any[] }) {
  return (
    <>
      <div>
