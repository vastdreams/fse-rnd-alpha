...
Table~\ref{tab:sample} reports sample construction and coverage statistics for the snapshot. The ``unique tickers'' count represents all companies that appear in the S\&P 500 at any point during the sample period and have data in the snapshot; actual constituents per formation year approximate 500 as the index changes over time.
