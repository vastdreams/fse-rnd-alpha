...
\addplot[black!60,dashed] coordinates {(1995,0) (2024,0)};
\end{axis}
\end{tikzpicture}
...
Primary inference is anchored on Fama-MacBeth cross-sectional tests (Table~\ref{tab:fama_macbeth_monthly}) and monthly factor spanning (Table~\ref{tab:spanning_tests}), which provide statistical significance. The annual non-overlapping series (Table~\ref{tab:annual_hml_summary}) serves as a descriptive summary of the premium's magnitude and persistence.
