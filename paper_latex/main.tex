...
\noindent\textbf{Results.} The \textbf{HML\_RD} premium (Q5 minus Q1) averages \textbf{\AnnualMeanPremium\%} per year in non-overlapping annual returns. Equivalently, the top R\&D-intensity quintile outperformed the bottom quintile by approximately \AnnualMeanPremium\% per year over the sample period. This difference is statistically significant with conservative Newey--West inference \citep{newey_west_1987} ($t = \AnnualTStat$, $p = \AnnualPValue$), and is positive in \AnnualPositiveYears{} of \AnnualNYears{} years (\AnnualWinRatePct\% win rate).
...
\begin{tcolorbox}[title=Exit Handling in Tier-1 Data, colback=yellow!5, colframe=yellow!40, breakable]
...
\begin{tcolorbox}[title=Rolling Windows and Horizon Decay, colback=yellow!5, colframe=yellow!40, breakable]
...
\begin{tcolorbox}[title=Sector Contribution is Material, colback=yellow!5, colframe=yellow!50]
