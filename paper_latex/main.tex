...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Net premium (benchmark-relative):} After costs, the strategy delivers \NetPremiumAfterCostsPct\% annual net premium versus SPY (S\&P 500 total-return proxy via \texttt{adj\_close}). Backtest period: \BacktestPeriodLabel{} (N=\BacktestNYears).
\end{itemize}
