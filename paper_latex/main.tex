...
\begin{itemize}[leftmargin=*]
    \item The annual non-overlapping premium averages \AnnualMeanPremium\% ($t = \AnnualTStat$) over \AnnualNYears{} years. Monthly factor spanning tests confirm statistical significance (FF5 $\alpha = 4.37\%$, $p < 0.01$), and Fama-MacBeth regressions corroborate the cross-sectional relationship ($p = \FamaMacBethRDPValue$~\FamaMacBethRDSignificantStars).
