# Sub-Research 4 (Archived Markdown Mirror): Mechanisms (Qualitative)
...
The prior markdown draft included operational-performance tables that were not computed by the platform and therefore
could not be guaranteed factual. Those have been removed.

---

## What this sub-research covers

- Intangible capital and why expensing can distort comparability
- Sector-specific lag intuition (without claiming estimated causal lag lengths)
- Interpretation guardrails: association vs causation
