    ...
    *,
    ...
    try:
        ...
        if isinstance(inv, dict) and isinstance(inv.get("portfolio_performance"), dict) and isinstance(inv.get("benchmark_performance"), dict):
            ...
            # Publication-facing benchmark: SPY (cap-weighted S&P 500 price-return proxy via close).
            # Keep the cohort equal-weight benchmark as a secondary comparison in the backtest payload.
            benchmark_universe = "SPY_close_price_return_proxy"
            ...
            payload["transaction_costs"] = {
                ...
                "definition": {
                    ...
                    "gross_premium": "strategy_gross_annualized_return − SPY_gross_annualized_return (price returns)",
                    "net_premium": "strategy_net_annualized_return − SPY_gross_annualized_return (price returns)",
